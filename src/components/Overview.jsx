  ...
  return (
    <div className="flex flex-wrap justify-center items-center gap-4 p-4">
      <div className="flex flex-col gap-4">
        <div className="card bg-base-100 w-full shadow-xl" style={{ width: '400px', height: '297px', marginBottom: '0px' }}>
        ...
        <div className="card bg-base-100 w-full shadow-xl" style={{ width: '400px', height: '297px', marginTop: '20px' }}>
      ...
      <div className="card bg-teal-800 shadow-xl w-full flex justify-center items-center" style={{ width: '800px', height: '608px' }}>
